  ...
  group('Layer 1: Component Kit Golden Suite (C01~C20)', () {
    ...
    testWidgets('C13. [ActivityInputBox] 单层提交框', (tester) async {
      ...
      await pumpVisual(
        tester,
        state: state,
        // ActivityPage scrolls: the surface must be tall enough for the input
        // box to be built at all. The golden still captures only the finder's
        // subtree, so the image stays 510x56.
